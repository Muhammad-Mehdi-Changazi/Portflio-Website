...
import ProfilePic from '../styles/LinkedIn.jpeg';
                ...
                <section id="about" className="about-section">
                    ...
                    <div className="about-section" style={{ textAlign: 'center', color: 'white', fontWeight: 'normal' }}>
                        <p>
                            ...
                            <span style={{ fontSize: '1.2em', color: 'white', fontWeight: 'bold' }}>Muhammad Mehdi,</span> and I am{' '}
                            <span style={{ color: '#00bccde5', fontSize: '1.8em', fontWeight: 'bold' }}>{typedPhrase}</span>.
                        </p>

                        <div className="about-card">
                            <p>
                                I am a <span className="highlighted">Software Engineer at Syscov</span>, building scalable applications using <span className="highlighted">Django</span>, <span className="highlighted">FastAPI</span>, <span className="highlighted">React</span>, and <span className="highlighted">Azure</span>. I also lead a team at <span className="highlighted">NIC Quetta</span> developing an <span className="highlighted">AI-powered trip planning system</span>. Previously, I worked as an <span className="highlighted">Associate Software Engineer at SnackOut Technologies</span> and completed a <span className="highlighted">Software Development Internship at SigmaTec Solutions</span>. My expertise spans <span className="highlighted">Web and Mobile App Development</span> using <span className="highlighted">MERN</span>, <span className="highlighted">React Native</span>, <span className="highlighted">AWS</span>, and <span className="highlighted">PostgreSQL</span>. I hold a <span className="highlighted">BS in Computer Science</span> from <span className="highlighted">LUMS</span>.
                            </p>
                        ...
                        <div className="experience-card">
                            ...
                            <div style={{ 
                                ...
                                <div className="experience-details">
                                    <strong className="role"><span style={{ color: "#d8d3d3" }}>Software Engineer (July 2025 - Present)</span></strong>
                                    <ul style={{ paddingLeft: '20px', margin: '20px 0' }}>
                                        <li style={{ marginBottom: '5px' }}>Developing and maintaining scalable software products using <span className="highlighted">Django</span>, <span className="highlighted">FastAPI</span>, and <span className="highlighted">React</span>.</li>
                                        <li style={{ marginBottom: '5px' }}>Collaborating with cross-functional teams to build efficient APIs and user interfaces for multiple projects.</li>
                                        <li style={{ marginBottom: '5px' }}>Integrating secure backend systems with <span className="highlighted">PostgreSQL</span> and <span className="highlighted">MongoDB</span> databases.</li>
                                        <li style={{ marginBottom: '5px' }}>Deploying applications on <span className="highlighted">Microsoft Azure</span> and optimizing performance and reliability.</li>
                                        <li style={{ marginBottom: '5px' }}>Writing clean, maintainable, and reusable code while adhering to best software engineering practices.</li>
                                        <li style={{ marginBottom: '5px' }}>Participating in system design, sprint planning, and code reviews to ensure timely feature delivery.</li>
                                    </ul>
                                    <div className="skills-icons">
                                        <i className="fab fa-python skill-logo" title="Python" style={{ margin: '10px', color: '#00bccd', fontSize: '50px' }}></i>
                                        ...
                                        <i className="fas fa-leaf skill-logo" title="MongoDB" style={{ margin: '10px', color: '#00bccd', fontSize: '50px' }}></i>
                                        <i className="fas fa-cloud skill-logo" title="Azure" style={{ margin: '10px', color: '#00bccd', fontSize: '50px' }}></i>
                                        <i className="fas fa-code skill-logo" title="FastAPI" style={{ margin: '10px', color: '#00bccd', fontSize: '50px' }}></i>
                                        <i className="fas fa-project-diagram skill-logo" title="Django" style={{ margin: '10px', color: '#00bccd', fontSize: '50px' }}></i>
                                    </div>
                                </div>
                            </div>
                        </div>
